...
@WebServlet(name = "ItemsSorterByCostAscendingController", value = "/items-sort-asc-servlet")
public class ItemsSorterByCostAscendingController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Sorter.sortItemsByCostAscending(items);
